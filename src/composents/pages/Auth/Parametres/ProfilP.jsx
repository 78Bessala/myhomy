...
const ProfilP = () => {
  return (
    <div className="min-h-screen max-w-sm mx-auto bg-white font-sans text-[13px] ">
      ...
      {/* Bottom navigation */}
      <nav className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-sm bg-white border-t border-gray-200 shadow-[0_-2px_6px_rgba(0,0,0,0.08)]">
        <div className="flex justify-between px-6 py-2 text-[11px]">
          <div className="flex flex-col items-center text-gray-500">
            <RiHome4Fill className="text-[20px]" />
            <span>Maison</span>
          </div>
          <div className="flex flex-col items-center text-gray-500">
            <IoBookOutline className="text-[20px]" />
          ...
          <div className="flex flex-col items-center text-gray-500">
            <BiMessageRounded className="text-[20px]" />
            <span>Message</span>
          </div>
          <div className="flex flex-col items-center text-[#0078EF] font-semibold">
