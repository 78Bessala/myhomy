...
function Login() {
  ...
  const handleLogin = async (e) => {
    e.preventDefault()
    try {
      const data = await apiRequest("/auth/jwt/login", "POST", { username, password }, null)
    ...
    <main className="h-screen flex items-center justify-center  md:p-16 bg-gray-100 overflow-hidden">
      ...
      ">
        ...
        <div className=" bg-[#A3D2FF]  md:bg-[#EBEBF2] flex  gap-12 md:gap-0 flex-col md:flex-row flex-1 md:rounded-xl">
          ...
          {/* Formulaire */}
          <div className="w-full md:rounded-xl  h-full md:max-w-full  flex  flex-col gap-4 md:gap-8 lg:gap-12 md:min-h-full  bg-[#EBEBF2]   rounded-t-3xl   p-8 lg:p-12">
            ...
            <div className="flex flex-col gap-4">
              ...
              <button
                ...
                className="w-full bg-[#0078EF]  h-12 cursor-pointer  text-base text-white py-3 rounded-[10px] hover:bg-blue-600 transition-colors"
              >
                se connecter
              </button>
