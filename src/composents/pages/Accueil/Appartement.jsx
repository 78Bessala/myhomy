...
<div className=" flex  flex-col  gap-8 m-4 mb-20">
    ...
    <div className=" flex flex-col gap-2">
        ...
        {/* Image */}
   <Link to="/DetailsA" className="w-full h-64">
   <div
     ...
     {/* sous titre de l'image */}
        <div className="mx-2 flex  justify-between">
            ...
            <div>
                ...
                <h1 className="font-bold  text-sm text-black "> Efoulan ,Yaounde</h1>
                <h2 className="text-xs  text-black "> A partir de juin 2025</h2>
                 <h2 className="text-xs  text-black "> 300.000/mois</h2>
            </div>
     ...
     {/* sous titre de l'image */}
        <div className="mx-2 flex  justify-between">
            ...
            <div>
                ...
                <h1 className="font-bold  text-sm text-black "> Bafou ,Dschang</h1>
                <h2 className="text-xs  text-black "> A partir de juin 2025</h2>
                 <h2 className="text-xs  text-black "> 500.000/mois</h2>
            </div>
     ...
     {/* sous titre de l'image */}
        <div className="mx-2 flex  justify-between">
            ...
            <div>
                ...
                <h2 className="text-xs  text-black "> A partir de fervrier 2025</h2>
                 <h2 className="text-xs  text-black "> 200.000/mois</h2>
            </div>
     ...
     {/* sous titre de l'image */}
        <div className="mx-2 flex  justify-between">
            ...
            <div>
                ...
                <h1 className="font-bold  text-sm text-black "> pk-8 ,Douala</h1>
                <h2 className="text-xs  text-black "> A partir de juillet 2025</h2>
                 <h2 className="text-xs  text-black "> 250.000/mois</h2>
            </div>
