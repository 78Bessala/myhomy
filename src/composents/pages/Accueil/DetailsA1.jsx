...
<section className='flex flex-col gap-8'> 
      ...
      <div className=' flex flex-col gap-1'>
             <div className="  flex flex-col justify-between p-4 md:h-[400px]  w-full h-82 bg-cover bg-center "
              style={{ backgroundImage: `url(${image1})` }}>
                <div className="flex justify-between"> 
                   <div className="border border-white text-black bg-[#FFFFFF] text-xs  h-10 w-10 rounded-full flex justify-center items-center"> 
                              <Link to="/appartement" className="">   <img  src={fleche} className='h-6 w-6'/></Link>
                        </div>
            ...
            <div className=' flex justify-between mx-6 my-2'>
                  <div className=' flex flex-col  gap-0.5'>
                        <h1 className='font-bold texte-sm text-black md:text-xl '> Appartement Meuble</h1>
                        <h1 className='text-xs md:text-sm'>Disponible a partir de juin 2025</h1>
                        <div className=' flex gap-1'>
                              <img src={map} className='w-4 h-4'/>
                              <h2 className='text-xs md:text-sm'> Bafou,Dschang</h2>
                        </div>

                  </div>

                  <h1 className='text-sm md:text-base bg-[#A3D2FF]  md:w-[100px] md:h-[32px]  w-[80px] h-[24px] rounded-[8px] flex justify-center items-center'>  a louer</h1>
            </div>
      </div>
       ...
       <div className='mx-6 my-1 flex  justify-between '>
            <div className=' flex  gap-2 '>
                  ...
                  <div className=' flex flex-col'>
                        <h2 className='md:text-xl'> Mr gregorie ntolo</h2>
                          <h2 className='text-[#58575D] md:text-base'> prestataire</h2>
                  </div>
             </div>
             <div className=' flex flex-col justify-end items-end gap-1'>
                  <img src={check} className='w-6 h-6 mr-4 '/>
                  <button className=' w-24 h-8  md:w-36 md:h-10 bg-[#0078EF] rounded-[8px] text-white md:text-xl'> Discuter</button>
             </div> 
      </div>  
            <hr className='bg-[#0078EF] h-0.5'/> 
      </div>
      ...
      <div className=' flex flex-col gap-4 mx-6'>
           ...
           <div className='flex flex-col gap-3'>
             ...
             <div className=' h-12 md:h-16 flex  gap-4 items-center bg-[#D9E8FF] p-4 rounded-[8px]'>
                  ...
                  <h1 className='text-sm  md:text-base flex justify-center items-center'>2 Salons, 2 Chambres, 2 Salles de bain, 1 Cuisine, Parking, Piscine, Terrasse  </h1>
           </div>

           <div className='  h-12  md:h-16 flex gap-4 items-center bg-[#D9E8FF] p-4 rounded-[8px]'>
            <img src={main} className='w-6 h-6 '/>
            <h1 className='text-sm md:text-base   flex justify-center items-center w-[294px]'>500.000 Fcfa par mois avec une caution de 150.000 Fcfa    </h1>
            </div>
           </div>
      ...
      <button 
        ...
        className='w-10/12 h-12  md:text-2xl md:h-16 bg-[#0078EF] mx-6 rounded-[8px] text-base text-white'
      > 
        Reserver 
      </button>
