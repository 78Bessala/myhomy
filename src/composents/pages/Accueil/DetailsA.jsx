      ...
      <div className=' flex flex-col gap-1'>
            ...
            <div className=' flex justify-between mx-6 my-2'>
                  <div className=' flex flex-col  gap-0.5'>
                        <h1 className='font-bold texte-sm md:text-xl text-black'> Appartement non Meuble</h1>
                        <h1 className='text-xs md:text-sm'>Disponible a partir de juin 2025</h1>
                        <div className=' flex gap-1'>
                              <img src={map} className='w-4 h-4'/>
                              <h2 className='text-xs md:text-sm'> Efoulan,Yaounde</h2>
                        </div>
      ...
      <div className=' flex flex-col gap-4 mx-6'>
           ...
           <div className='flex flex-col gap-3'>
             ...
             <div className=' h-12 md:h-16 flex  gap-4 items-center bg-[#D9E8FF] p-4 rounded-[8px]'>
                  ...
                  <h1 className='text-sm md:text-base flex justify-center items-center'>1 Salon, 2 Chambres, 2 Salles de bain, 1 Cuisine, Parking, Terrasse  </h1>
           </div>

           <div className='  h-12 md:h-16  flex gap-4 items-center bg-[#D9E8FF] p-4 rounded-[8px]'>
            <img src={main} className='w-6 h-6 '/>
            <h1 className='text-sm md:text-base flex justify-center items-center w-[294px]'>300.000 Fcfa par mois avec une caution de 100.000 Fcfa    </h1>
            </div>
           </div>
