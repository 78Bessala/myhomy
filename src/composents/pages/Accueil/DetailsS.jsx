      ...
      <div className=' flex flex-col gap-1'>
            ...
            <div className=' flex justify-between mx-6 my-2'>
                  <div className=' flex flex-col  gap-0.5'>
                        <h1 className='font-bold texte-sm md:text-xl text-black'> Studio Meuble</h1>
                        <h1 className='text-xs md:text-sm'>Disponible a partir de juillet 2025</h1>
                        <div className=' flex gap-1'>
                              <img src={map} className='w-4 h-4'/>
                              <h2 className='text-xs md:text-sm'> Odza,Yaounde</h2>
                        </div>
      ...
      <div className=' flex flex-col gap-4 mx-6'>
           ...
           <div className='flex flex-col gap-3'>
             ...
             <div className=' h-12 md:h-16 flex  gap-4 items-center bg-[#D9E8FF] p-4 rounded-[8px]'>
                  ...
                  <h1 className='text-sm md:text-base flex justify-center items-center'>1 Salon, 1 Chambre, 1 Salle de bain, 1 Cuisine,  Terrasse  </h1>
           </div>

           <div className='  h-12 md:h-16 flex gap-4 items-center bg-[#D9E8FF] p-4 rounded-[8px]'>
            <img src={main} className='w-6 h-6 '/>
            <h1 className='text-sm  md:text-base flex justify-center items-center w-[294px]'>60.000 Fcfa par mois avec une caution de 60.000 Fcfa    </h1>
            </div>
           </div>
          
        </div>
<div className='mx-4  flex  justify-center items-center'>
      <button onClick={handleReservation} className=' w-10/12 h-12 md:h-16 md:text-2xl bg-[#0078EF] mx-6 rounded-[8px] text-base text-white'> Reserver </button>
