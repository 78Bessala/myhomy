      ...
      <div className=' flex flex-col gap-1'>
              ...
              style={{ backgroundImage: `url(${image})` }}>
                <div className="flex justify-between"> 
                   <div className="border border-white text-black bg-[#FFFFFF] text-xs  h-10 w-10 rounded-full flex justify-center items-center"> 
                              <Link to="/villa" className=""><img  src={fleche} className='h-6 w-6'/></Link>  
                        </div>
            ...
            <div className=' flex justify-between mx-6 my-2'>
                  <div className=' flex flex-col  gap-0.5'>
                        <h1 className='font-bold texte-sm text-black md:text-xl'> Villa Meublee</h1>
                        <h1 className='text-xs md:text-sm'>Disponible a partir de mars 2025</h1>
                        <div className=' flex gap-1'>
                              <img src={map} className='w-4 h-4'/>
                              <h2 className='text-xs md:text-sm'> Olembe,Yaounde</h2>
                        </div>

                  </div>

                  <h1 className='text-sm md:text-base bg-[#A3D2FF]  w-[80px] h-[24px]  md:w-[100px] md:h-[32px] rounded-[8px] flex justify-center items-center'>  a louer</h1>
            </div>
      </div>
      ...
      <div className=' flex flex-col gap-4 mx-6'>
           ...
           <div className='flex flex-col gap-3'>
             ...
             <div className=' h-12 md:h-16  flex  gap-4 items-center bg-[#D9E8FF] p-4 rounded-[8px]'>
                  ...
                  <h1 className='text-sm  md:text-base flex justify-center items-center'>2 Salons, 5 Chambres, 3 Salles de bain, 1 Cuisine, Parking, Piscine, Terrasse,  </h1>
           </div>

           <div className='  h-12 md:h-16  flex gap-4 items-center bg-[#D9E8FF] p-4 rounded-[8px]'>
            <img src={main} className='w-6 h-6 '/>
            <h1 className='text-sm  md:text-base flex justify-center items-center w-[294px]'>1.700.000 Fcfa par mois avec une caution de 400.000 Fcfa    </h1>
            </div>
           </div>
