...
<section className='flex flex-col gap-8'> 
      ...
      <div className=' flex flex-col gap-1'>
            ...
            <div className=' flex justify-between mx-6 my-2'>
                  <div className=' flex flex-col  gap-0.5'>
                        ...
                        <h1 className='text-xs'>Disponible a partir de mai 2025</h1>
      ...
      <div className=' flex flex-col gap-4 mx-6'>
           ...
           <div className='  h-12 flex gap-4 items-center bg-[#D9E8FF] p-4 rounded-[8px]'>
            ...
            <h1 className='text-sm  flex justify-center items-center w-[294px]'>1.500.000 Fcfa par mois avec une caution de 350.000 Fcfa    </h1>
            </div>
           </div>
