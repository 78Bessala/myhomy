      ...
      <div className=' flex flex-col gap-1'>
            ...
            <div className=' flex justify-between mx-6 my-2'>
                  <div className=' flex flex-col  gap-0.5'>
                        <h1 className='font-bold texte-sm md:text-xl text-black'> Chambre Meublee</h1>
                        <h1 className='text-xs md:text-sm'>Disponible a partir de juin 2025</h1>
                        <div className=' flex gap-1'>
                              <img src={map} className='w-4 h-4'/>
                              <h2 className='text-xs md:text-sm'> Mendong,Yaounde</h2>
                        </div>

                  </div>

                  <h1 className='text-sm md:text-base md:w-[100px] md:h-[32px] bg-[#A3D2FF]  w-[80px] h-[24px] rounded-[8px] flex justify-center items-center'>  a louer</h1>
            </div>
      </div>
      ...
      <div className=' flex flex-col gap-4 mx-6'>
           ...
           <div className='flex flex-col gap-3'>
             ...
             <div className=' h-12 md:h-16 flex  gap-4 items-center bg-[#D9E8FF] p-4 rounded-[8px]'>
                  ...
                  <h1 className='text-sm md:text-base flex justify-center items-center'>1 Salle de bain, 1 Cuisine,1 Chambre,  Terrasse  </h1>
           </div>

           <div className='  h-12 md:h-16 flex gap-4 items-center bg-[#D9E8FF] p-4 rounded-[8px]'>
            <img src={main} className='w-6 h-6 '/>
            <h1 className='text-sm  md:text-base flex justify-center items-center w-[294px]'>50.000 Fcfa par mois avec une caution de 30.000 Fcfa    </h1>
            </div>
           </div>
...
<div className='mx-4 flex   justify-center items-center'>
      <button 
        ...
        className='w-10/12 h-12 md:h-16  md:text-2xl bg-[#0078EF] mx-6 rounded-[8px] text-base text-white flex justify-center  items-center'
      > 
        Reserver 
      </button>
