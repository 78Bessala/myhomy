      ...
      <div className=' flex flex-col gap-4 mx-6'>
           ...
           <div className='flex flex-col gap-3'>
             ...
             <div className=' h-12 md:h-16  flex  gap-4 items-center bg-[#D9E8FF] p-4 rounded-[8px]'>
                  ...
                  <h1 className='text-sm flex justify-center items-center md:text-base'>2 Salons, 4 Chambres, 3 Salles de bain, 1 Cuisine, Parking, Piscine, Terrasse  </h1>
           </div>

           <div className='  h-12 md:h-16  flex gap-4 items-center bg-[#D9E8FF] p-4 rounded-[8px]'>
            <img src={main} className='w-6 h-6 '/>
            <h1 className='text-sm  flex justify-center items-center w-[294px] md:text-base'>1.500.000 Fcfa par mois avec une caution de 500.000 Fcfa    </h1>
            </div>
           </div>
          
        </div>
<div className='mx-4  flex  justify-center items-center'>
      <button onClick={handleReservation} className=' w-10/12 h-12 md:h-16 md:text-2xl  v bg-[#0078EF] mx-6 rounded-[8px] text-base text-white'> Reserver </button>
