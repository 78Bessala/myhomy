...
<section className='flex flex-col gap-8'> 
      ...
      <div className=' flex flex-col gap-1'>
             <div className="  flex flex-col md:h-[400px]  justify-between p-4 w-full h-82 bg-cover bg-center "
            ...
            <div className=' flex justify-between mx-6 my-2'>
                  <div className=' flex flex-col  gap-0.5'>
                        <h1 className='font-bold texte-sm text-black md:text-xl'> Duplex non Meuble</h1>
                        <h1 className='text-xs md:text-sm'>Disponible a partir de juin 2023</h1>
                        <div className=' flex gap-1'>
                              <img src={map} className='w-4 h-4'/>
                              <h2 className='text-xs md:text-sm'> Pk-20,Douala</h2>
                        </div>
       ...
       <div className='mx-6 my-1 flex  justify-between '>
            <div className=' flex  gap-2 '>
             ...
             <div className=' flex flex-col justify-end items-end gap-1'>
                  ...
                  <button className=' w-24 h-8 md:w-36 md:h-10 bg-[#0078EF] rounded-[8px] text-white'> Discuter</button>
             </div> 
      </div>  
            <hr className='bg-[#0078EF] h-0.5'/> 
      </div>
      ...
      <div className=' flex flex-col gap-4 mx-6'>
           ...
           <div className='flex flex-col gap-3'>
             ...
             <div className=' h-12 md:h-16 flex  gap-4 items-center bg-[#D9E8FF] p-4 rounded-[8px]'>
                  ...
                  <h1 className='text-sm flex justify-center items-center md:text-base'>2 Salons, 4 Chambres, 2 Salles de bain, 1 Cuisine, Parking, Terrasse  </h1>
           </div>

           <div className='  h-12 md:h-16 flex gap-4 items-center bg-[#D9E8FF] p-4 rounded-[8px]'>
            <img src={main} className='w-6 h-6 '/>
            <h1 className='text-sm  flex justify-center items-center w-[294px] md:text-base'>1000.000 Fcfa par mois avec une caution de 300.000 Fcfa    </h1>
            </div>
           </div>
...
<div className='mx-4  justify-center items-center'>
      <button 
        ...
        className='w-10/12 h-12  md:h-16 md:text-2xl bg-[#0078EF] mx-6 rounded-[8px] text-base text-white'
      > 
        Reserver 
      </button>
